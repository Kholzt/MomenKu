...
<head>
    ...
    <title>The Wedding Of {{$data->brides[0]->nickname}} &
        {{$data->brides[1]->nickname}}
    </title>
...
<body>
    ...
    <section
        ...
        style="z-index: 10;background-image:    linear-gradient(to bottom, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)),  url(https://drive.google.com/thumbnail?id=image2.jpg);height: 100vh;background-repeat: no-repeat;background-size: cover;background-position: center;">
        <h4 class="text-white mb-2 comic-neue ">The Wedding Of</h4>
        <img class="mb-4 object-fit-cover" src="https://drive.google.com/thumbnail?id=image2.jpg"
            style="width: 200px;height: 200px;border-radius: 50%;" alt="">
        <h1 class="great-vibes text-white">{{$data->brides[0]->nickname}} & {{$data->brides[1]->nickname}}</h1>
    ...
    <main id="content">
        <section class="" id="home">
            <div style="background-image:    linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),  url(https://drive.google.com/thumbnail?id=image1.jpg);height: 100vh;background-repeat: no-repeat;background-size: cover;background-position: center;"
                ...
                <h1 class="great-vibes text-white text-center">{{$data->brides[0]->nickname}} <br> & <br> {{$data->brides[1]->nickname}}</h1>
                <h6 class="text-white mb-4 comic-neue ">Kpd. Bpk/Ibu/Saudara/I</h6>
                ...
                <img src="https://drive.google.com/thumbnail?id=1zpkIJm3P4__rOsjzDQzyy7RcMZGf747V&sz=w1000" class="img-fluid position-absolute bottom-0 left-0" alt="">
            </div>
        </section>
        <section class="" id="mempelai">
            <div style="min-height: 500px;padding-top:7rem;padding-bottom: 7rem;"
                ...
                <img style="width: 300px;" src="https://drive.google.com/thumbnail?id=12lQBmyZAmzW9zDpAHxKK5hvKM5_VgYlR&sz=w1000
" class="item-bottom" alt="">
                ...
                <div class="row mb-5 w-100 item-bottom justify-content-center">
                    <div class="col-md-4 col-12 text-center">
                        <h2 class="mb-2 great-vibes fw-bold">{{$data->brides[0]->full_name}}</h2>
                        <img class="mb-2" src="https://drive.google.com/thumbnail?id=1npRLS3pzkRR-WMI8mii0EbVL0mr5xwCa&sz=w1000" alt="">
                        <p>Putra Dari <br>
                            {{$data->brides[0]->father_name}} & <br>
                            {{$data->brides[0]->mother_name}}
                    </div>
                    <div class="col-md-4 item-bottom col-12 text-center">
                        <h2 class="mb-2 great-vibes fw-bold">{{$data->brides[1]->full_name}}</h2>
                        <img class="mb-2" src="https://drive.google.com/thumbnail?id=1npRLS3pzkRR-WMI8mii0EbVL0mr5xwCa&sz=w1000" alt="">
                        <p>Putri Dari <br>
                            {{$data->brides[1]->father_name}} & <br>
                            {{$data->brides[1]->mother_name}}
                        </p>
                    </div>
                </div>
                <h5 class="mb-5 mt-5">Jum'at, 27 Desember 2024</h5>
                <div class="row mb-5">
                    <div class="col">
                ...
                <img src="https://drive.google.com/thumbnail?id=1zpkIJm3P4__rOsjzDQzyy7RcMZGf747V&sz=w1000" class="img-fluid position-absolute  left-0"
                    style="z-index: 2;bottom: 0px;" alt="">

                <img src="https://drive.google.com/thumbnail?id=1fpfD3KCYPC7jstqfZUnCh4jN9-lYGQRv&sz=w1000" class="img-fluid position-absolute top-0 left-0"
                    style="z-index: 2;" alt="">

                <img src="https://drive.google.com/thumbnail?id=1It6xhamllErCdLIagDUqP_foCs7o2_Bd" class=" position-absolute "

                    style="min-width: 150px;top:-20px;left: -7%;width: 30%;" alt="">

                <img src="https://drive.google.com/thumbnail?id=11SocFpn0rgTJMgAH6qFCKoA6w-anThKe" class=" position-absolute "
                    style="min-width: 150px;top:-150px;right: -30%;width: 60%;" alt="">
                <img src="https://drive.google.com/thumbnail?id=1K5t3EeyWBX5AGxeyCNj1THKM_d7Lk9-x" class=" position-absolute "
                    style="min-width: 150px;bottom:-150px;left: -30%;width: 60%;transform: rotate(180deg);" alt="">
                <img src="https://drive.google.com/thumbnail?id=1It6xhamllErCdLIagDUqP_foCs7o2_Bd" class=" position-absolute "
                    style="min-width: 150px;bottom:-20px;right: -7%;width: 30%;transform: rotate(200deg);" alt="">
            </div>
        </section>
        <section class="" id="acara">
            <div style="min-height: 500px;padding-top:7rem;padding-bottom: 7rem;"
                ...
                <div class="row mb-4 w-100 justify-content-center">
                    ...
                    <div class="col-md-4 col-12">
                        <div
                            ...
                            <h1 class="great-vibes">{{$event->event_name}}</h1>
                            <p class="mb-3"><i class="fa fa-calendar"></i> {{$event->event_date}}</p>
                            <p class="mb-3"><i class="fa fa-clock"></i> {{$event->start_time}} WIB - {{$event->end_time ?? "Selesai"}}</p>
                ...
                <h1 class="great-vibes item-bottom">{{$data->brides[0]->nickname}} & {{$data->brides[1]->nickname}}</h1>
                ...
                <img class="mb-5" src="https://drive.google.com/thumbnail?id=1npRLS3pzkRR-WMI8mii0EbVL0mr5xwCa" alt="">
                <div class="mb-4 item-bottom-zoom" style="max-width: 100%;width: 600px;aspect-ratio: 3/2;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3948.6638690124423!2d113.3137!3d-8.236514999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwMTQnMTEuNSJTIDExM8KwMTgnNDkuMyJF!5e0!3m2!1sid!2sid!4v1733534093102!5m2!1sid!2sid"
                        width="100%" height="100%" style="border: 0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade">
                    </iframe>
                </div>

                <a href="https://maps.app.goo.gl/ZmCWnuaMoYjtHHURA"
        ...
        <section class="" id="ucapan">
            <div style="min-height: 500px;padding-top:7rem;padding-bottom: 7rem;"
                ...
                <form id="comment-form" class="position-relative item-bottom d-flex flex-column" action="" style="width: 600px;max-width: 100%;z-index:3;">
                    <input type="text" placeholder="Nama lengkap" name="nama" id="" class="form-control mb-2">
                    <textarea name="keterangan" class="form-control" id="" placeholder="Tulis ucapan & doa restu"></textarea>
                    @csrf
    ...
    <script>
        const showComment = () => {
            fetch("/comments").then(json => json.json()).then(data => {
                let html = "";
                data.forEach(d => {
                    const date = new Date(d.created); // Format ISO (YYYY-MM-DD)
                    ...
                    html += `<li class="border-b  mb-2 item-bottom">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-start">${d.keterangan}</div>
                            </div>
                        </li>`;
                });
    ...
    <script>
        // Timeout schedule
        // Set target date
        const targetDate = new Date('{{$data->primaryEvent->event_date}} {{$data->primaryEvent->end_time??"23:00"}}:00').getTime();
